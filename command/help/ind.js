...
exports.noregis = (pushname) =>{
	return`ʜᴀʟᴏ ${pushname} ᴀɴᴅᴀ ʙʟᴜᴍ ᴠᴇʀɪғʏ ᴅɪ AHS sɪʟᴀᴋᴀɴ ᴋᴇᴛɪᴋ .ᴅᴀғᴛᴀʀ ᴜɴᴛᴜᴋ ᴅᴀғᴛᴀʀ ᴀɴᴅᴀ`
	}
exports.regis = () =>{
...
ᴛᴇʀɪᴍᴀᴋᴀsɪʜ sᴜᴅᴀʜ ᴅᴀғᴛᴀʀ AHS BOT sɪʟᴀᴋᴀɴ ᴋᴇᴛɪᴋ .ᴍᴇɴᴜ ᴜɴᴛᴜᴋ ʟɪʜᴀᴛ ғɪᴛᴜʀ
`
	}
...
exports.wait = () =>{
	return`「⏱」AHS BOT sᴇᴅᴀɴɢ ᴘʀᴏsᴇs ʜᴀʀᴀᴘ sᴀʙᴀʀ ᴋᴀʟᴏ ɢᴀᴋ ᴍᴜɴᴄᴜʟ ᴍᴜɴɢᴋɪɴ ᴇʀʀᴏʀ`
	}
exports.ok = () =>{
	return` 「✔」 sᴜᴋsᴇs`
	}
...
exports.menu = (prefix, salam, pushname) =>{
  ...
  • ɴᴀᴍᴀ sᴀʏᴀ AHS BOT ᴅɪ ᴘᴀɴɢɢɪʟ AHS / AHS   
  • ᴍᴇɴᴜ ɪɴɪ ᴇᴍɢ ᴅɪᴋɪᴛ ᴊᴀᴅɪ ʏɢ ᴀᴅᴀ ᴀᴊᴀ ʏᴀ ᴍᴇɴᴜ ɴʏᴀ >.<   
  • ғᴏʟʟᴏᴡ ɢɪᴛʜᴜʙ : 「github.com/BotMIZUKImdv2」
